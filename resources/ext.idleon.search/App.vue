...
:root {
  ...
  --search-button-background: no-repeat 43% 56% url("/w/skins/Timeless/resources/images/search-ltr.svg") transparent;
}
...
.mw-enhanced-search {
  ...
  .cdx-text-input__input {
    ...
    line-height: 1.5;
    margin: 0 !important;
    padding: 0.4em 4.5em 0.2em 2em !important;
    border: none;
  ...
  .cdx-search-input__end-button {
    ...
    color: transparent;
    background: var(--search-button-background) !important;
    position: fixed;
